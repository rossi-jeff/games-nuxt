		...
		<div v-if="props.status == GameStatus.Playing">
			...
			<div v-if="props.fired == false">
				<div class="player-fire-controls">
					...
					<div v-if="state.errors.length == 0" class="fire-button-div">
...
div.player-fire-controls {
	@apply flex flex-wrap mb-2 mx-2;
}
div.player-fire-controls label {
	@apply max-w-fit mr-2 inline-block font-bold;
}
div.player-fire-controls select,
div.sea-battle-player-turn button {
	@apply border border-black rounded px-2 py-1 bg-slate-200 mr-2;
}
div.sea-battle-player-turn button:hover {
	@apply bg-slate-600 text-white;
}
div.fire-button-div button {
	@apply mt-0;
}
.Miss span {
